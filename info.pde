...
void load() {
  ...
  drinks[0] = new int[]{10, 0, 0, 0, 0, 0, 0, 0, 0};
  drinks[1] = new int[]{0, 10, 0, 0, 0, 0, 0, 0, 0};
  drinks[2] = new int[]{0, 0, 10, 0, 0, 0, 0, 0, 0};
  drinks[3] = new int[]{0, 0, 0, 10, 0, 0, 0, 0, 0};
  ...
  drinks[13] = new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10};  
}
